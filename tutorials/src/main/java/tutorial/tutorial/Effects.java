...
//        glowEffect();
    ...
    private HashMap<String, Supplier<Effect>> getEffects() {
        ...
        it is being generated by a spot light. A little hard to see but if you brighten upm zoom in your screen and get
        near to the X, Y, Z point you will see the light
         */
